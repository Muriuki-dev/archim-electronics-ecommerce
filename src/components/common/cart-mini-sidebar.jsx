          ...
          <div className="cartmini__top-wrapper">
            <div className="cartmini__top p-relative">
              <div className="cartmini__top-title">
                <h4>Archim Electronics Shopping cart</h4>
              </div>
  ...
  />
                  ...
                  <div className="cartmini__content">
                    <h5 className="cartmini__title">
                      <Link href={`/product-details/Ksh{item._id}`}>{item.title}</Link>
                    </h5>
                    <div className="cartmini__price-wrapper">
                      {item.discount > 0 ? <span className="cartmini__price">Ksh{(Number(item.price) - (Number(item.price) * Number(item.discount)) / 100).toFixed(2)}</span> : <span className="cartmini__price">Ksh{item.price.toFixed(2)}</span>}
          ...
          <div className="cartmini__checkout">
            ...
            <div className="cartmini__checkout-btn">
              ...
              <Link href="/checkout" onClick={handleCloseCartMini} className="tp-btn tp-btn-border w-100">Proceed to Order</Link>
            </div>
          </div>
        </div>
      </div>
